...
### 2.5 推送代码到远程仓库
当完成一个功能点或阶段工作时，将代码推送到远程仓库 develop 分
支
...
$git push origin develop
```
__注:禁止将未编译或编译不通过的代码提交到远程仓库，如果编码工
作进行未完成可以提交到本地仓库中，等待该功能点全部实现后再将
代码推送到远程仓库中。__
### 2.6 将代码发布到测试分支
...
$git checkout ‐b hotfix -v1.0.0.170718 
v1.0.0.170718
```
### 3.4 修复代码后可以查询修改过的地方
